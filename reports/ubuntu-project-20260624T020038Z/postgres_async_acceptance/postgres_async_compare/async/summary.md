...
- Verdict: **WARN**
- Run directory: `/home/lab2439/Work/lzww/LogServe/reports/ubuntu-project-20260624T020038Z/postgres_async_acceptance/postgres_async_compare/async`
- Package: `/home/lab2439/Work/lzww/LogServe/reports/ubuntu-project-20260624T020038Z/postgres_async_acceptance/postgres_async_compare/async/experiment-package.tar.gz`
- Mode: `compose`
...
| `benchmark` | PASS | 40 | `benchmark.stderr.log` |
...
- `metadata_materializer_pending_deltas`: 3
- `metadata_materializer_flush_count`: 43
- `metadata_materializer_flush_errors`: n/a
- `metadata_materializer_lag_ms`: 31

## PostgreSQL Benchmark Stats

- `postgres_mode`: async
- `postgres_elapsed_ms`: 40067
- `postgres_transactions_delta`: 53
- `postgres_row_writes_delta`: 679
- `postgres_transactions_per_sec`: 1.323
- `postgres_row_writes_per_sec`: 16.947
