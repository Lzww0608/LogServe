...
- Verdict: **WARN**
- Run directory: `/home/lab2439/Work/lzww/LogServe/reports/ubuntu-project-20260624T020038Z/postgres_async_acceptance/postgres_async_compare/sync`
- Package: `/home/lab2439/Work/lzww/LogServe/reports/ubuntu-project-20260624T020038Z/postgres_async_acceptance/postgres_async_compare/sync/experiment-package.tar.gz`
- Mode: `compose`
...
| `compose_build` | PASS | 1 | `compose_build.log` |
...
| `postgres_before_benchmark` | PASS | 1 | `postgres_before_benchmark.stderr.log` |
...
- `workflow_p95_ms`: 921
- `workflow_p99_ms`: 921
- `task_throughput_tps`: 5.010
- `task_p99_latency_ms`: 210
...
- `postgres_mode`: sync
- `postgres_elapsed_ms`: 39987
- `postgres_transactions_delta`: 2851
- `postgres_row_writes_delta`: 4101
- `postgres_transactions_per_sec`: 71.298
- `postgres_row_writes_per_sec`: 102.558
