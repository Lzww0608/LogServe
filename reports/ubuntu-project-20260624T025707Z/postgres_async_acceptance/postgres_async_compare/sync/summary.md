...
- Verdict: **WARN**
- Run directory: `/home/lab2439/Work/lzww/LogServe/reports/ubuntu-project-20260624T025707Z/postgres_async_acceptance/postgres_async_compare/sync`
- Package: `/home/lab2439/Work/lzww/LogServe/reports/ubuntu-project-20260624T025707Z/postgres_async_acceptance/postgres_async_compare/sync/experiment-package.tar.gz`
- Mode: `compose`
...
| `python_grpc_deps` | PASS | 1 | `python_grpc_deps.log` |
...
- `postgres_mode`: sync
- `postgres_elapsed_ms`: 39913
- `postgres_transactions_delta`: 2889
- `postgres_row_writes_delta`: 4012
- `postgres_transactions_per_sec`: 72.382
- `postgres_row_writes_per_sec`: 100.519
